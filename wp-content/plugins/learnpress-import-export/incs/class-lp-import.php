...
if ( !class_exists( 'LP_Import' ) ) {
	...
	class LP_Import {
		...
		public function import_step_1() {
			$file = lp_import_handle_upload( $_FILES['lpie_import_file'], array( 'mimes' => array( 'xml' => 'text/xml' ) ) );
		...
		public function import_view_step_1() {
			...
			<ul class="form-options">
				<li>
					<label>
						<?php _e( 'Save imported file', 'learnpress-import-export' ); ?>
					</label>
			...
			<input type="hidden" name="import-file" value="tmp/<?php echo basename( $this->_import_data['file'] ); ?>" />
		...
		public function import_view_step_3() {
			$_REQUEST['step'] = 0;
			?><h4><?php _e( 'Done', 'learnpress-import-export' );?></h4>
			<?php
